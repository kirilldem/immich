  ...
  private savePath(pathType: PathType, id: string, newPath: string) {
    switch (pathType) {
      case AssetPathType.ORIGINAL: {
        return this.assetRepository.updateAll([id], { originalPath: newPath });
      }
      case AssetPathType.JPEG_THUMBNAIL: {
        return this.assetRepository.updateAll([id], { resizePath: newPath });
      }
      case AssetPathType.WEBP_THUMBNAIL: {
        return this.assetRepository.updateAll([id], { webpPath: newPath });
      }
      case AssetPathType.ENCODED_VIDEO: {
        return this.assetRepository.updateAll([id], { encodedVideoPath: newPath });
      }
      case AssetPathType.SIDECAR: {
        return this.assetRepository.updateAll([id], { sidecarPath: newPath });
      }
      case PersonPathType.FACE: {
